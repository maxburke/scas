...
static const struct scas_arg_t *
find_short_arg(const char *arg_string, size_t num_args, const struct scas_arg_t *args, const char **value)
{
    size_t i;
...
static const struct scas_arg_t *
find_long_arg(const char *arg_string, size_t num_args, const struct scas_arg_t *args, const char **value)
{
    size_t i;
...
static const struct scas_arg_t *
find_arg(const char *arg_string, size_t num_args, const struct scas_arg_t *args, const char **value)
{
    *value = NULL;
...
scas_arg_parse(struct scas_arg_context_t *context)
{
    ...
    for (i = 1; i < argc; ++i)
    {
        ...
        {
            struct scas_arg_t positional_arg = { NULL, NULL, ARG_TYPE_POSITIONAL, NULL };
